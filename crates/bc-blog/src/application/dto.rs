//! Wire DTOs of the blog BC.
//!
//! These are the projections that cross the wire between the Leptos server
//! functions and the browser. Plain data, no logic.

use serde::{Deserialize, Serialize};

use crate::domain::model::{BlogPost, BlogPostSummary};
